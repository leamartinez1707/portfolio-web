      ...
      <section id="home" className="relative min-h-screen flex items-center pt-32 pb-40 px-8 overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto w-full grid grid-cols-12 gap-8 items-center">
          <div className="col-span-12 lg:col-span-8">
            ...
            <h1 className="font-headline text-6xl md:text-8xl font-black leading-[0.9] tracking-tighter mb-12 text-on-surface">
              FULL STACK <br />
          ...
          <div className="col-span-12 lg:col-span-4 hidden lg:block">
            <div className="relative p-8 bg-surface-container-low rounded-lg border border-outline-variant/10 shadow-2xl">
