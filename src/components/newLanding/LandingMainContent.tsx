      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <header className="mb-24 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="max-w-2xl">
            ...
            <h2 className="font-headline font-black text-6xl md:text-8xl leading-none tracking-tighter text-on-surface">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-16">
          {/* Frontend block */}
          <div className="md:col-span-8 bg-surface-container-low p-10 rounded-xl relative overflow-hidden group border border-outline-variant/10">
              ...
              {featuredSkills.map(skill => (
                <div key={skill.name}>
                  ...
                  <div className="w-full bg-surface-container-highest h-1 rounded-full overflow-hidden">
                    <div className="bg-secondary h-full transition-all duration-700" style={{ width: skill.level + '%' }}></div>
                  </div>
                </div>
              ))}
            </div>
          ...
          {/* Backend block */}
          <div className="md:col-span-4 bg-surface-container-low p-10 rounded-xl group hover:bg-surface-container-high transition-colors border border-outline-variant/10">
          ...
          {/* Design focus block */}
          <div className="md:col-span-3 bg-primary-container p-10 rounded-xl flex items-center justify-center text-center">
            <div>
