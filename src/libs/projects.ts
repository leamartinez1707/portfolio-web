export const projects = {
    ...
    en: [
        ...
        },
        {
            ...
            description: 'Tool that uses AI to improve resumes. Users upload their CV as text and receive improvement suggestions based on best practices for their target role.',
            image: '/cvboost_screenshot.png',
            technologies: ['React.js', 'JavaScript', 'OpenAI API', 'Axios', 'PDFjs', 'Tailwind CSS', 'Vercel'],
            github: 'https://github.com/leamartinez1707/cv_boost',
            demo: 'https://cv-ai-boost.vercel.app/',
        ...
        },
        {
            ...
            description: 'Telemedicine platform connecting patients with doctors, enabling appointment scheduling, online consultations, and medical record management.',
            image: '/saludnet_screenshot.png',
        ...
        {
            title: 'NM Massages - Massage Business Landing Page',
            description: 'Landing page for a massage business showcasing services and pricing, with online appointment booking via WhatsApp.',
            image: '/nmasajes_1.png',
            technologies: ['Node.js', 'TypeScript', 'React.js', 'Tailwind CSS', 'Motion', 'Vercel'],
            github: 'https://github.com/leamartinez1707/nm-masajes-landing/tree/master',
            demo: 'https://nmasajes.vercel.app/',
